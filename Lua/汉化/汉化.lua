...
NM(RF("Ragebot"),"暴力")
    ...
    NM(RF("暴力", "Automate"),"自动操作")
        ...
        NM(RF("暴力", "自动操作", "Shared", "Auto Fire"),"自动开火")
            ...
            NM(RF("暴力", "自动操作", "Shared", "自动开火", "Auto Revolver"),"左轮自动预热")
        ...
        NM(RF("暴力", "自动操作", "Pistol", "Auto Fire"),"自动开火")
            NM(RF("暴力", "自动操作", "Pistol", "自动开火", "Auto Pistol"),"自动手枪")
        NM(RF("暴力", "自动操作", "Pistol", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动操作", "Pistol", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动操作", "Pistol", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动操作", "Pistol", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动操作", "Pistol", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动操作", "Pistol", "自动急停", "Between Shots"),"射击间隙")
        -- Heavy Pistol
        NM(RF("暴力", "自动操作", "Heavy Pistol", "Auto Fire"),"自动开火")
            NM(RF("暴力", "自动操作", "Heavy Pistol", "自动开火", "Auto Pistol"),"自动手枪")
            NM(RF("暴力", "自动操作", "Heavy Pistol", "自动开火", "Auto Revolver"),"左轮自动预热")
        NM(RF("暴力", "自动操作", "Heavy Pistol", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动操作", "Heavy Pistol", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动操作", "Heavy Pistol", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动操作", "Heavy Pistol", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动操作", "Heavy Pistol", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动操作", "Heavy Pistol", "自动急停", "Between Shots"),"射击间隙")
        -- Submachine Gun
        NM(RF("暴力", "自动操作", "Submachine Gun", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动操作", "Submachine Gun", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动操作", "Submachine Gun", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动操作", "Submachine Gun", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动操作", "Submachine Gun", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动操作", "Submachine Gun", "自动急停", "Between Shots"),"射击间隙")
        -- Rifle
        NM(RF("暴力", "自动操作", "Rifle", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动操作", "Rifle", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动操作", "Rifle", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动操作", "Rifle", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动操作", "Rifle", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动操作", "Rifle", "自动急停", "Between Shots"),"射击间隙")
        -- Shotgun
        NM(RF("暴力", "自动操作", "Shotgun", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动操作", "Shotgun", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动操作", "Shotgun", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动操作", "Shotgun", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动操作", "Shotgun", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动操作", "Shotgun", "自动急停", "Between Shots"),"射击间隙")
        -- Scout
        NM(RF("暴力", "自动操作", "Scout", "Auto Fire"),"自动开火")
            NM(RF("暴力", "自动操作", "Scout", "自动开火", "Auto Pistol"),"自动手枪")
        NM(RF("暴力", "自动操作", "Scout", "Auto Scope"),"自动开关镜")
            NM(RF("暴力", "自动操作", "Scout", "自动开关镜", "Scope"),"自动开镜")
            NM(RF("暴力", "自动操作", "Scout", "自动开关镜", "Unscope"),"自动关镜")
        NM(RF("暴力", "自动操作", "Scout", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动操作", "Scout", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动操作", "Scout", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动操作", "Scout", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动操作", "Scout", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动操作", "Scout", "自动急停", "Between Shots"),"射击间隙")
        -- Auto Sniper
        NM(RF("暴力", "自动操作", "Auto Sniper", "Auto Scope"),"自动开关镜")
            NM(RF("暴力", "自动操作", "Auto Sniper", "自动开关镜", "Scope"),"自动开镜")
            NM(RF("暴力", "自动操作", "Auto Sniper", "自动开关镜", "Unscope"),"自动关镜")
        NM(RF("暴力", "自动操作", "Auto Sniper", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动操作", "Auto Sniper", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动操作", "Auto Sniper", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动操作", "Auto Sniper", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动操作", "Auto Sniper", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动操作", "Auto Sniper", "自动急停", "Between Shots"),"射击间隙")
        -- Sniper
        NM(RF("暴力", "自动操作", "Sniper", "Auto Fire"),"自动开火")
            NM(RF("暴力", "自动操作", "Sniper", "自动开火", "Auto Pistol"),"自动手枪")
        NM(RF("暴力", "自动操作", "Sniper", "Auto Scope"),"自动开关镜")
            NM(RF("暴力", "自动操作", "Sniper", "自动开关镜", "Scope"),"自动开镜")
            NM(RF("暴力", "自动操作", "Sniper", "自动开关镜", "Unscope"),"自动关镜")
        NM(RF("暴力", "自动操作", "Sniper", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动操作", "Sniper", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动操作", "Sniper", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动操作", "Sniper", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动操作", "Sniper", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动操作", "Sniper", "自动急停", "Between Shots"),"射击间隙")
        -- Light Machine Gun (只有 Auto Stop)
        NM(RF("暴力", "自动操作", "Light Machine Gun", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动操作", "Light Machine Gun", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动操作", "Light Machine Gun", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动操作", "Light Machine Gun", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动操作", "Light Machine Gun", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动操作", "Light Machine Gun", "自动急停", "Between Shots"),"射击间隙")
