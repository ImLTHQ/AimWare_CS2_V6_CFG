...
NM(RF("Ragebot"),"暴力")
    ...
    NM(RF("暴力", "Automate"),"自动")
        ...
        NM(RF("暴力", "自动", "Shared", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动", "Shared", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动", "Shared", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动", "Shared", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动", "Shared", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动", "Shared", "自动急停", "Between Shots"),"射击间隙")
        -- Zeus
        NM(RF("暴力", "自动", "Zeus", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动", "Zeus", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动", "Zeus", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动", "Zeus", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动", "Zeus", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动", "Zeus", "自动急停", "Between Shots"),"射击间隙")
        -- Pistol
        NM(RF("暴力", "自动", "Pistol", "Auto Fire"),"自动开火")
            NM(RF("暴力", "自动", "Pistol", "自动开火", "Auto Pistol"),"自动手枪")
        NM(RF("暴力", "自动", "Pistol", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动", "Pistol", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动", "Pistol", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动", "Pistol", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动", "Pistol", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动", "Pistol", "自动急停", "Between Shots"),"射击间隙")
        -- Heavy Pistol
        ...
        NM(RF("暴力", "自动", "Heavy Pistol", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动", "Heavy Pistol", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动", "Heavy Pistol", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动", "Heavy Pistol", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动", "Heavy Pistol", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动", "Heavy Pistol", "自动急停", "Between Shots"),"射击间隙")
        -- Submachine Gun
        NM(RF("暴力", "自动", "Submachine Gun", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动", "Submachine Gun", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动", "Submachine Gun", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动", "Submachine Gun", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动", "Submachine Gun", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动", "Submachine Gun", "自动急停", "Between Shots"),"射击间隙")
        -- Rifle
        NM(RF("暴力", "自动", "Rifle", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动", "Rifle", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动", "Rifle", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动", "Rifle", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动", "Rifle", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动", "Rifle", "自动急停", "Between Shots"),"射击间隙")
        -- Shotgun
        NM(RF("暴力", "自动", "Shotgun", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动", "Shotgun", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动", "Shotgun", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动", "Shotgun", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动", "Shotgun", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动", "Shotgun", "自动急停", "Between Shots"),"射击间隙")
        -- Scout
        ...
        NM(RF("暴力", "自动", "Scout", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动", "Scout", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动", "Scout", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动", "Scout", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动", "Scout", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动", "Scout", "自动急停", "Between Shots"),"射击间隙")
        -- Auto Sniper
        ...
        NM(RF("暴力", "自动", "Auto Sniper", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动", "Auto Sniper", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动", "Auto Sniper", "自动急停", "Slow Walk"),"慢走")
            NM(RF("暴力", "自动", "Auto Sniper", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动", "Auto Sniper", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动", "Auto Sniper", "自动急停", "Between Shots"),"射击间隙")
        -- Sniper
        ...
        NM(RF("暴力", "自动", "Sniper", "Auto Stop"),"自动急停")
            NM(RF("暴力", "自动", "Sniper", "自动急停", "Stop"),"急停")
            NM(RF("暴力", "自动", "Sniper", "自动急停", "Slow Walk"),"慢走")
        ...
        NM(RF("暴力", "自动", "Light Machine Gun", "Auto Stop"),"自动急停")
            ...
            NM(RF("暴力", "自动", "Light Machine Gun", "自动急停", "Duck"),"蹲下")
            NM(RF("暴力", "自动", "Light Machine Gun", "自动急停", "Early"),"提前")
            NM(RF("暴力", "自动", "Light Machine Gun", "自动急停", "Between Shots"),"射击间隙")
